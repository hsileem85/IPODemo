...
export const T = {
  ar: {
    ...
    colClientName: "اسم العميل", colIPOName: "الاكتتاب", colUnifiedCode: "الكود الموحد", colSubQty: "الكمية المكتتب بها", colCost: "التكلفة",
    egp: "ج.م", shares: "سهم",
  ...
  en: {
    ...
    colClientName: "Client Name", colIPOName: "IPO", colUnifiedCode: "Unified Code", colSubQty: "Subscribed Qty", colCost: "Cost (EGP)",
