...
export const T = {
  ar: {
    ...
    brokerCsvHint: "أعمدة الملف: ClientName, BrokerCode, UnifiedCode, Qty, Cost, Date, Ref",
  ...
  en: {
    ...
    brokerCsvHint: "Columns: ClientName, BrokerCode, UnifiedCode, Qty, Cost, Date, Ref",
