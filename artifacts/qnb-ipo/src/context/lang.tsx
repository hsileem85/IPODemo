...
export const T = {
  ar: {
    ...
    pricePerShareLabel: "سعر الاكتتاب (ج.م)", offeringSizeLabel: "حجم الطرح (سهم)", subDateLabel: "تاريخ الاكتتاب",
  ...
  en: {
    ...
    pricePerShareLabel: "Offer Price (EGP)", offeringSizeLabel: "Offering Size (shares)", subDateLabel: "Subscription Date",
