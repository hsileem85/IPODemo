...
export const T = {
  ar: {
    ...
    roleSupervisor: "حالة الطلبات", roleComms: "التواصل",
    ...
    doc3: "بيان الحافظ", doc4: "توكيل رسمي (إن وجد)",
    ...
    boTabFollowUp: "المتابعة", boTabBroker: "اكتتابات الوسيط", supTabFollowUp: "متابعة الطلبات",
    menuBasicData: "البيانات الأساسية", menuBrokers: "الوسطاء", menuCustodians: "المحافظون",
    menuReports: "التقارير", rptDesc: "تقارير إدارة الاكتتاب مع تصدير Excel و PDF",
    rptAllClients: "تقرير العملاء", rptAllocation: "تقرير التخصيص", rptRefund: "تقرير الاسترداد",
    rptExportExcel: "تصدير Excel", rptExportPdf: "تصدير PDF",
    rptFilters: "معايير البحث والتصفية",
    rptAllIpos: "جميع الأسهم", rptAllPhases: "جميع المراحل", rptAllStatuses: "جميع الحالات", rptAllBranches: "جميع الفروع",
    rptAllBrokers: "جميع الوسطاء", rptAllCustodians: "جميع أمناء الحفظ",
    rptDateFrom: "من تاريخ", rptDateTo: "إلى تاريخ", rptSearch: "ابحث باسم العميل، الرقم القومي، أو الكود الموحد...",
    rptResults: "النتائج", rptNoResults: "لا توجد نتائج — عدّل معايير البحث",
    rptTotalSubs: "إجمالي الاشتراكات", rptAmountDue: "المبلغ المطلوب (EGP)", rptAmountPaid: "المبلغ المدفوع (EGP)",
    rptCoverageRatio: "نسبة التغطية", rptPaidVsDue: "المدفوع / المطلوب",
    rptRequestedShares: "الأسهم المطلوبة", rptAllocatedShares: "الأسهم المخصصة",
    rptAllocPct: "نسبة التخصيص %", rptAllocRatio: "معدل التخصيص", rptAllocVsReq: "المخصص / المطلوب",
    rptRefundAmount: "مبلغ الاسترداد (EGP)", rptTotalRefund: "إجمالي الاسترداد (EGP)",
    rptGeneratedAt: "تاريخ إنشاء التقرير", rptShares: "سهم",
    rptSubId: "رقم الاشتراك", rptName: "الاسم", rptNID: "الرقم القومي", rptUnifiedCode: "الكود الموحد",
    rptBranch: "الفرع", rptIPO: "الورقة المالية", rptPhase: "المرحلة", rptStatus: "الحالة", rptDate: "التاريخ",
    rptBroker: "الوسيط", rptBrokerCode: "كود الوسيط", rptCustodian: "أمين الحفظ", rptCustodianCode: "كود أمين الحفظ",
    brokersTitle: "إدارة الوسطاء", brokersDesc: "إضافة وعرض بيانات الوسطاء",
    custodiansTitle: "إدارة المحافظين", custodiansDesc: "إضافة وعرض بيانات المحافظين",
    bdName: "الاسم", bdCode: "الرمز", bdEmail: "البريد الإلكتروني",
    addBrokerBtn: "إضافة وسيط جديد", addCustodianBtn: "إضافة محافظ جديد",
    bdSavedOk: "تم الحفظ بنجاح", bdCodeCol: "الرمز", bdEmailCol: "البريد",
    ...
    roleFA: "موظف الفرع", roleBO: "موظف المقاصة", roleSup: "حالة الطلبات", roleSA: "مدير النظام", roleCommU: "مسؤول التواصل",
    ...
    notifPanelTitle: "الإشعارات", notifPanelEmpty: "لا توجد إشعارات جديدة", notifPanelMarkAll: "تعليم الكل كمقروء",
    notifPendingApprovals: "اكتتابات بانتظار الموافقة", notifPendingKYC: "طلبات KYC معلقة",
    notifPendingBatches: "دفعات وسيط بانتظار المراجعة", notifPendingCash: "اكتتابات نقدية معلقة",
    clientNameLabel: "اسم العميل", clientNamePlaceholder: "يظهر بعد إدخال الرمز الموحد",
    custodianLabel: "الحافظ", custodianSelectPlaceholder: "اختر الحافظ",
    notifPendingMCDR: "اكتتابات بانتظار تخصيص MCDR", notifGoTo: "الانتقال إلى",
    ...
    colBroker: "الوسيط", colCustodian: "الحارس الأمين",
    brokerClientsTitle: "قائمة عملاء الوسيط", totalClients: "إجمالي العملاء", totalValue: "إجمالي القيمة (ج.م)",
    colClientName: "اسم العميل", colIPOName: "الاكتتاب", colUnifiedCode: "الكود الموحد", colSubQty: "الكمية المكتتب بها", colCost: "التكلفة", colDate: "التاريخ", colRef: "المرجع",
    ...
    fixAllocTitle: "FIX 4.4 — رسائل التخصيص", fixAllocDesc: "توليد رسائل تأكيد التخصيص وإرسالها إلى MCDR",
    fixAllocGenerateBtn: "توليد رسائل FIX التخصيص", fixAllocCopied: "تم النسخ!",
    fixAllocSubmit: "تأكيد الإرسال إلى MCDR", fixAllocSent: "تم الإرسال إلى MCDR ✓",
    fixAllocRecord: "سجل التخصيص", fixAllocMsgs: "رسائل التخصيص",
    supFixMcdrBtn: "فحص FIX MCDR", supFixMcdrTitle: "FIX 4.4 — التحقق من تخصيص MCDR",
    supFixMcdrDesc: "توليد رسالة FIX 4.4 والتحقق منها مع MCDR كخطوة نهائية قبل الاعتماد",
    supFixMcdrGenerate: "توليد رسالة FIX 4.4", supFixMcdrVerify: "التحقق مع MCDR",
    supFixMcdrPassMsg: "تم التحقق من MCDR — يمكنك الاعتماد الآن",
    supFixMcdrFailMsg: "فشل التحقق من MCDR — تم النقل إلى المتابعة",
    supFixMcdrBatchFailMsg: "تحتوي الدفعة على عملاء فشلوا في التحقق من MCDR",
    supFixMcdrToFollowUp: "نقل إلى المتابعة", supFixMcdrFailed: "فشل MCDR",
    supFixMcdrCheckAll: "فحص FIX MCDR للكل",
    supFixMcdrCheckAllResult: (v: number, f: number) => `${v} تم التحقق منهم · ${f} نُقلوا إلى المتابعة`,
    supFixMcdrCheckAllBatchResult: (v: number, f: number) => `${v} دفعات تم التحقق منها · ${f} فشلت`,
    ...
    selectAllBrokers: "تحديد جميع الوسطاء",
    deselectAll: "إلغاء الكل",
    brokersSelected: (n: number) => `${n} وسيط محدد`,
    generateFixAll: "توليد FIX للجميع",
    submitAllBatches: "إرسال جميع الدفعات",
    brokerWizardStep1: "رفع الملف",
    brokerWizardStep2: "مراجعة الطلبات",
    brokerWizardStep3: "توليد FIX",
    brokerWizardStep4: "التحقق والإرسال",
    brokerCsvHint: "أعمدة الملف: Client Name, IPO Name, Unified Code, Subscribed Quantity, Cost, Date, Broker, Custodian, REF",
    brokersFound: (n: number) => `${n} وسيط`,
    cashVerification: "التحقق من النقدية",
    mcdrVerification: "تحقق MCDR",
    verifyAll: "التحقق من الكل",
    brokerStepNext: "التالي",
    brokerStepBack: "السابق",
    cashPass: "موثق",
    cashFail: "رصيد غير كافٍ",
    mcdrPass: "تخصيص موثق",
    mcdrFail: "فشل التخصيص",
  ...
  en: {
    ...
    roleSupervisor: "Requests Status", roleComms: "Communications",
    ...
    doc3: "Custodian Statement", doc4: "POA (if applicable)",
    ...
    boTabFollowUp: "Follow Up", boTabBroker: "Broker Subscriptions", supTabFollowUp: "Follow Up",
    menuBasicData: "Basic Data", menuBrokers: "Brokers", menuCustodians: "Custodians",
    menuReports: "Reports", rptDesc: "IPO subscription reports with Excel & PDF export",
    rptAllClients: "All Client Report", rptAllocation: "Allocation Report", rptRefund: "Refund Report",
    rptExportExcel: "Export Excel", rptExportPdf: "Export PDF",
    rptFilters: "Search & Filter Criteria",
    rptAllIpos: "All IPO Stocks", rptAllPhases: "All Phases", rptAllStatuses: "All Statuses", rptAllBranches: "All Branches",
    rptAllBrokers: "All Brokers", rptAllCustodians: "All Custodians",
    rptDateFrom: "Date From", rptDateTo: "Date To", rptSearch: "Search by client name, NID, or unified code...",
    rptResults: "Results", rptNoResults: "No results — adjust your search criteria",
    rptTotalSubs: "Total Subscriptions", rptAmountDue: "Amount Due (EGP)", rptAmountPaid: "Amount Paid (EGP)",
    rptCoverageRatio: "Coverage Ratio", rptPaidVsDue: "Paid vs. Due",
    rptRequestedShares: "Requested Shares", rptAllocatedShares: "Allocated Shares",
    rptAllocPct: "Alloc %", rptAllocRatio: "Allocation Rate", rptAllocVsReq: "Allocated vs. Requested",
    rptRefundAmount: "Refund Amount (EGP)", rptTotalRefund: "Total Refunded (EGP)",
    rptGeneratedAt: "Report Generated At", rptShares: "shares",
    rptSubId: "Sub ID", rptName: "Name", rptNID: "NID", rptUnifiedCode: "Unified Code",
    rptBranch: "Branch", rptIPO: "IPO", rptPhase: "Phase", rptStatus: "Status", rptDate: "Date",
    rptBroker: "Broker", rptBrokerCode: "Broker Code", rptCustodian: "Custodian", rptCustodianCode: "Custodian Code",
    brokersTitle: "Brokers Management", brokersDesc: "Add and view broker records",
    custodiansTitle: "Custodians Management", custodiansDesc: "Add and view custodian records",
    bdName: "Name", bdCode: "Code", bdEmail: "Email",
    addBrokerBtn: "Add New Broker", addCustodianBtn: "Add New Custodian",
    bdSavedOk: "Saved successfully", bdCodeCol: "Code", bdEmailCol: "Email",
    ...
    roleFA: "Front Office Agent", roleBO: "Back Office Ops", roleSup: "Requests Status", roleSA: "System Admin", roleCommU: "Comms Officer",
    ...
    notifPanelTitle: "Notifications", notifPanelEmpty: "You're all caught up!", notifPanelMarkAll: "Mark all as read",
    notifPendingApprovals: "Subscriptions pending approval", notifPendingKYC: "KYC records awaiting review",
    notifPendingBatches: "Broker batches pending review", notifPendingCash: "Subscriptions with pending cash",
    clientNameLabel: "Client Name", clientNamePlaceholder: "Auto-filled after unified code lookup",
    custodianLabel: "Custodian", custodianSelectPlaceholder: "Select Custodian",
    notifPendingMCDR: "Subscriptions pending MCDR allocation", notifGoTo: "Go to",
    ...
    colBroker: "Broker", colCustodian: "Custodian",
    brokerClientsTitle: "Broker Client List", totalClients: "Total Clients", totalValue: "Total Value (EGP)",
    colClientName: "Client Name", colIPOName: "IPO", colUnifiedCode: "Unified Code", colSubQty: "Subscribed Qty", colCost: "Cost (EGP)", colDate: "Date", colRef: "REF",
    ...
    fixAllocTitle: "FIX 4.4 — Allocation Messages", fixAllocDesc: "Generate allocation confirmation messages and send to MCDR",
    fixAllocGenerateBtn: "Generate FIX Allocation Messages", fixAllocCopied: "Copied!",
    fixAllocSubmit: "Confirm Sent to MCDR", fixAllocSent: "Sent to MCDR ✓",
    fixAllocRecord: "Allocation Record", fixAllocMsgs: "Allocation Messages",
    supFixMcdrBtn: "FIX MCDR Check", supFixMcdrTitle: "FIX 4.4 — MCDR Allocation Check",
    supFixMcdrDesc: "Generate and verify FIX 4.4 message with MCDR as the final step before approval",
    supFixMcdrGenerate: "Generate FIX 4.4 Message", supFixMcdrVerify: "Verify with MCDR",
    supFixMcdrPassMsg: "MCDR Verified — Proceed to Approve",
    supFixMcdrFailMsg: "MCDR Verification Failed — Moved to Follow Up",
    supFixMcdrBatchFailMsg: "Batch contains clients that failed MCDR verification",
    supFixMcdrToFollowUp: "Move to Follow Up", supFixMcdrFailed: "MCDR Failed",
    supFixMcdrCheckAll: "FIX MCDR Check All",
    supFixMcdrCheckAllResult: (v: number, f: number) => `${v} verified · ${f} moved to Follow Up`,
    supFixMcdrCheckAllBatchResult: (v: number, f: number) => `${v} batches verified · ${f} failed`,
    ...
    selectAllBrokers: "Select All Brokers",
    deselectAll: "Deselect All",
    brokersSelected: (n: number) => `${n} broker(s) selected`,
    generateFixAll: "Generate FIX for All",
    submitAllBatches: "Submit All Batches",
    brokerWizardStep1: "Upload File",
    brokerWizardStep2: "Review Requests",
    brokerWizardStep3: "Generate FIX",
    brokerWizardStep4: "Verify & Submit",
    brokerCsvHint: "Columns: Client Name, IPO Name, Unified Code, Subscribed Quantity, Cost, Date, Broker, Custodian, REF",
    brokersFound: (n: number) => `${n} broker(s)`,
    cashVerification: "Cash Verification",
    mcdrVerification: "MCDR Verification",
    verifyAll: "Verify All",
    brokerStepNext: "Next",
    brokerStepBack: "Back",
    cashPass: "Verified",
    cashFail: "Insufficient Funds",
    mcdrPass: "Allocation Confirmed",
    mcdrFail: "Allocation Failed",
