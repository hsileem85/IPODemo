...
export const T = {
  ar: {
    ...
    foTabFollowUp: "متابعة الفرع",
    followUpTitle: "متابعة الفرع", followUpDesc: "تتبع حالة طلبات الاكتتاب المقدمة من الفرع",
  ...
  en: {
    ...
    foTabFollowUp: "Branch Follow Up",
    followUpTitle: "Branch Follow Up", followUpDesc: "Track the status of subscription requests submitted by this branch",
