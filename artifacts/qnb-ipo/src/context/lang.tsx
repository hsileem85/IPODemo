...
export const T = {
  ar: {
    ...
    colEligible: "الأسهم المؤهلة", colSubscribed: "الأسهم المكتتبة", colQuantity: "الكمية",
    ...
    statusSubmitted: "مرسل", statusRpaAllocating: "في تخصيص RPA",
    statusMcdrAccepted: "MCDR مقبول", statusMcdrRejected: "MCDR مرفوض",
    ...
    statusPendingCash: "نقدية معلقة", statusPendingMCDR: "في انتظار تخصيص MCDR", statusRejected: "مرفوض",
    ...
    // FIX MCDR manual check translations removed — handled by external RPA system
    ...
    coveredIpoSharesLabel: "عدد أسهم مرحلة التغطية",
    coveredIpoSharesHint: "يُحدَّد في البيانات الأساسية — يحل محل رفع ملف MCDR لتحديد الأهلي في مرحلة التغطية",
    saveBtn: "حفظ", editBtn: "تعديل",
    mcdDisabledCoveredTitle: "رفع ملف MCDR غير متاح في مرحلة التغطية",
    mcdDisabledCoveredDesc: "تم تعطيل رفع ملف MCDR والمطابقة لمرحلة التغطية. يتم تحديد الأسهم المؤهلة من البيانات الأساسية > الأسهم > عدد أسهم التغطية.",
  ...
  en: {
    ...
    colEligible: "Eligible Shares", colSubscribed: "Subscribed Shares", colQuantity: "Quantity",
    ...
    statusSubmitted: "Submitted", statusRpaAllocating: "RPA Allocating",
    statusMcdrAccepted: "MCDR Accepted", statusMcdrRejected: "MCDR Rejected",
    ...
    statusPendingCash: "Pending Cash", statusPendingMCDR: "Pending MCDR Allocation", statusRejected: "Rejected",
    ...
    coveredIpoSharesLabel: "Covered IPO Shares",
    coveredIpoSharesHint: "Set in Basic Data — replaces MCDR upload for the covered-stage eligible total",
    saveBtn: "Save", editBtn: "Edit",
    mcdDisabledCoveredTitle: "MCDR Upload Disabled in Covered Stage",
    mcdDisabledCoveredDesc: "MCDR upload and reconciliation are disabled in the covered stage. Eligible shares come from Basic Data > IPO Stocks > Covered Shares.",
